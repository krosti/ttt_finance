...
jQuery.fn.extend({
	mopSlider:function(setting){
		...
		/* Modifed for tutorialzine */
			...
			btnLeft.src="app/webroot/js/mopSlider/sliderBtnLeftW.png";
			btnLeftF.src="app/webroot/js/mopSlider/sliderBtnLeftW_f.png";
			btnRight.src="app/webroot/js/mopSlider/sliderBtnRightW.png";
			btnRightF.src="app/webroot/js/mopSlider/sliderBtnRightW_f.png";
			btnCenter.src="app/webroot/js/mopSlider/sliderBtnW.png";
			btnChange.src="app/webroot/js/mopSlider/sliderBackRightRightW.png";
			btnChangeF.src="app/webroot/js/mopSlider/sliderBackRightRightW_f.png";
/*			backImg.src="mopSlider/paperBack.gif";*/
